...
<html>
  ...
  <body>
    ...
    <div class="container">
      ...
      <p class="pull-right">
	<a href="user-form.php?route=add" class="btn" type="button"><i class="icon-plus"></i> Add</a>
      </p>
	...
	<?php
	$query = mysql_query("SELECT * FROM web_users ORDER BY ID ASC");
	$numrows=@mysql_num_rows($query);
	if($numrows != 0) {
	while ($result = mysql_fetch_array($query)) {
	?>
	  ...
	  <tr>
	    ...
	    <td><?php if ($result['asesor'] == '0') { ?><i class="icon-remove"></i><?php } ?> <?php if ($result['asesor'] == '1') { ?><i class="icon-ok"></i><?php } ?></td>
	    <td>
	      <div class="btn-group">
		<a class="btn btn-primary" href="user-form.php?route=edit&id=<?php echo $result['id']; ?>"><i class="icon-pencil icon-white"></i> Edit</a>
		<a class="btn btn-primary dropdown-toggle" data-toggle="dropdown"><span class="caret"></span></a>
		<ul class="dropdown-menu">
		  <li><a href="user-form.php?route=edit&id=<?php echo $result['id']; ?>"><i class="icon-pencil"></i> Edit</a></li>
		  <li><a href="user-form.php?route=delete&id=<?php echo $result['id']; ?>"><i class="icon-trash"></i> Delete</a></li>
		</ul>
	      </div>
	    </td>
	  </tr>
