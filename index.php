  ...
  <body>
	...
	<div class="span8">
	  <div class="desc">
	    <div class="row-fluid">
	      <div class="span5">
		<center><img src="img/furtherlogo.jpg" alt="Further CSC" width="200px"></center><br/>
		<p><em>Further</em> es un grupo estudiantil que se encarga de apoyar a la educaci&oacute;n en M&eacute;xico. En esta p&aacute;gina podr&aacute;s crear tu cita para que recibas ayuda de un alumno asesor, o si lo prefieres, ver video tutoriales realizados por alumnos de la Prepa Tec. Si quieres formar parte del grupo, tambi&eacute;n existe la posibilidad de ser staff durante las actividades que el grupo realizar&aacute; a trav&eacute;s del semestre con el prop&oacute;sito de ayudar a una escuela con bajos recursos.</p>
	      </div>
	      <div class="span5">
		<div class="row-fluid">
		  <h2>Gracias a:</h2>
		  <div class="span4">
		    <a href="http://kindsnacks.com.mx/" target="_blank"><img id="kind" src="img/patrocinadores/kind.jpeg" alt="Further Patrocinio" style="padding-bottom: 5px;"></a>
		  </div>
		</div>
	      </div>
	    </div>
		...
		<p><a class="btn btn-warning" href="asesoria.php">Ver M&aacute;s &raquo;</a></p>
	      ...
	      <div class="span4">
		<img src="img/staff.jpg" alt="Further Patrocinio">
	      </div>
	      <div class="span3">
